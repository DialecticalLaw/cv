...
export const projects: ProjectInfo[] = [
  ...
  },
  {
    ...
    fullDesc:
      'Приложение для обмена сообщениями, которое включает в себя все необходимые функции для удобного общения. Пользователи могут отправлять, удалять и редактировать сообщения, а также отслеживать статус доставки каждого сообщения и видеть, кто из участников в онлайне. Это создает динамичную и интерактивную атмосферу общения. Для корректной работы приложения необходимо запустить локальный сервер, ссылка на который указана ниже.',
...
Наша платформа предлагает широкий ассортимент товаров с разных планет ⋆⭒.⋆🪐 ⋆⭒.⋆, которые пользователи могут просматривать и добавлять в свою корзину 🛒. Подробные описания продуктов и их характеристики помогают пользователям принимать обоснованные решения о покупке. Приложение включает в себя такие функции, как регистрация, вход в систему, поиск товаров и сортировка, для удобства пользователей.`,
  ...
  },
  {
    ...
    fullDesc:
      'Это портфолио было сделано с целью собрать воедино все мои проекты, сделанные до этого и подвести итоги обучения (которое, конечно, не заканчивается, ведь разработчик должен обучаться всегда). Проект написан на React и NextJS. В нём не использовались никакие сторонние UI библиотеки.',
    deployLink: '',
    serverLink: '',
    videoLink: null,
    imageLink: '',
